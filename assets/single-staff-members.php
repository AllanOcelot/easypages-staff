...
<?php get_header(); ?>
      ...
      <div class="staff-member-banner" style="background-image:url(<?php echo $staff_banner; ?>)" >
        <div class="text">
          <h1><?php echo the_title(); ?></h1>
          <?php if($staff_role != null || $staff_role != ""){
            echo "<h3>" . $staff_role . "</h3>";
          }?>
        </div>
      </div>

      <div class="staff-member-single-page">
   ...
   <div class="related-staff-members">
     <h3>Related Staff Members:</h3>
   <?php
